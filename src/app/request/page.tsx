...
function Page() {
  return (
    <section className="mx-auto max-w-[51.25rem] h-[80.4375rem] px-4 sm:px-12 py-14 border-4 rounded-3xl border-[#4472C4] flex flex-col items-center mb-4">
      ...
      <div className="flex flex-col text-center w-full items-center text-xs sm:text-lg gap-2 font-bold mb-14 break-keep">
