...
export default function Page() {
  return (
    <div>
      ...
      <div className="max-w-[1280px] mx-auto px-12 md:px-36 py-24">
        ...
        <div className="mt-24 relative">
          ...
          />
          <div className="absolute top-[5%] left-1/2 -translate-x-1/3 w-1/2">
            <Image src={'/teacher/강사사진.png'} alt="" width={0} height={0} sizes="100" className="w-3/4 md:hidden" />
          </div>
        </div>
      </div>
    </div>
