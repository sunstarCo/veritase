...
export default function Page() {
  return (
    <>
      <IntroBanner />
      <div className="w-full xl:max-w-[1280px] mx-auto">
        <div className="relative bg-[url('/banner/인사말.png')] w-full h-[716px]">
          {/* <Image src={'/banner/인사말.png'} width={0} sizes="100" height={0} style={{width: '100%'}} alt="회사소개배너" /> */}
          <article className="absolute top-16 left-16">
            <div className="flex gap-10 items-start">
              ...
              <div>
                ...
                <p className="max-w-[800px] break-keep mt-10 leading-[30px] font-medium pr-8">
                  ...
                  <span className="text-blue-4">학습의 성취감과 자신감</span>을 가질 수 있게 하는{' '}
                  <span className="text-blue-4">개인별, 수준별 맞춤학습을 지향</span>합니다. <br /> 또한, 학습자와
