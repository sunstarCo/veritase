...
export default function Page() {
  return (
    <div className="break-keep">
      ...
      <div className="mb-20">
        <article className="max-w-[1440px] mx-auto py-24 px-4 sm:px-20 ">
          ...
          <div className=" mt-16 pl-10">
            <div>
              ...
              <p className="w-full break-keep sm:border-l-4 border-l-2 border-blue-4 pl-5 mt-10 leading-[30px] font-medium pr-8">
                내신 성적이 부족해 수능에 올인하겠다는 학생 / 모의평가 성적이 내신성적에 비해 턱없이 부족한 학생 / 수능
                실패를 경험한 재수생/ 현재 자신의 위치보다 최상의 점수를 올리고자 하는 학생들에게 <br /> 특화된 핵심
                강의를 최고의 강사진들을 통해 생동감 넘치는 강의를 제공하는 회사입니다. <br />
              </p>
            </div>
          </div>
