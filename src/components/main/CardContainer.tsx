...
const cardData = [
  {
    img: 'bg-[url(/mainPage/회사소개.png)]',
    path: '/company/greeting',
    title: '회사소개',
    text: '여러분의 목표를 달성해드립니다',
  },
  {
    img: 'bg-[url(/mainPage/입시전략.png)]',
    path: '/plan/eduPeriod',
    title: '입시전략',
    text: '지금부터의 전략이 중요합니다',
  },
  {
    img: 'bg-[url(/mainPage/교육시스템.png)]',
    path: '/education/eduSystem',
    title: '교육시스템',
    text: '목표달성까지 함께합니다',
  },
  {
    img: 'bg-[url(/mainPage/후기.png)]',
    ...
    <div className="flex gap-4 w-full max-w-[1760px] mx-auto mb-20 overflow-scroll md:overflow-none">
      {cardData.map((card, i) => (
        <Link
          key={i}
          href={card.path}
          className={`${card.img} card bg-cover bg-no-repeat min-h-[550px] xl:min-h-[680px] flex items-end min-w-[260px] md:w-1/4 hover:w-[50%] break-keep transition-all duration-300 ease-out rounded-lg overflow-hidden`}>
