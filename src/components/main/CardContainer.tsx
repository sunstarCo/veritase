    ...
    <div className="flex gap-4 w-full max-w-[1760px] mx-auto mb-20 overflow-x-scroll lg:overflow-hidden">
      {cardData.map((card, i) => (
        <Link
          key={i}
          href={card.path}
          className={`${card.img} card bg-no-repeat min-h-[400px] md:min-h-[500px] xl:min-h-[600px] flex items-end min-w-[210px] md:min-w-[260px] md:w-1/4 hover:w-[50%] break-keep transition-all duration-400 ease-out rounded-lg overflow-hidden`}>
