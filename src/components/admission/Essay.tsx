      ...
      <article className="mt-10 mb-40">
        ...
        <div className="mt-4 px-12">
          ...
          <div className="mt-20">
            ...
            <p className="p-4">
              통합교과형 논술 예시 문항을 통해 적합한 학습법을 모색해 보는 것이 좋습니다. 인문계열에서 출제되는 수리
              논술의 경우, 정확한 답을 도출해내기 보다는 정답을 이끌어 내기 위한 과정을 논리적으로 설명하는 것이
              중요하므로 평소 풀이과정을 숙지할 필요가 있습니다. 자연계열의 경우 서술 분량의 제한이 없으므로 비교적
              자유로운 범위에서 본인의 의견을 피력할 수 있기 떄문에, 수학 교과를 기본으로 응용문제와 심화 학습의
              풀이과정을 숙지해둡니다.
            </p>
            ...
            <p className="font-semibold mt-10">4. 다양한 글 읽기 (특히 수능 국어영역 제시문 학습)</p>
            <p className="p-4">
